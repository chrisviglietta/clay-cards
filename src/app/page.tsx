...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fafafa] relative">
      ...
      {/* Decorative flowers */}
      <div className="absolute left-0 top-1/4 w-48 h-48 -translate-x-1/4">
        <Image src="/flowers-left.svg" alt="Decorative flowers" width={200} height={200} />
      </div>
      <div className="absolute right-0 bottom-1/4 w-48 h-48 translate-x-1/4">
        <Image src="/flowers-right.svg" alt="Decorative flowers" width={200} height={200} />
      </div>

      <div className="max-w-4xl mx-auto pt-32 px-4 relative z-10">
